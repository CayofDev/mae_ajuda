...
export default function Chat() {
  ...
  //       MessagesBoxRef.current.clientHeight;
  //   }, 1);
  // }
  ...
  //   setMessages([
  //     ...messages,
  //     { type: "right", content: newMessageInput, hora: new Date() },
  //   ]);
  //   setMessage("");
  //   scrollToBottom();
  // }
  ...
  return (
    ...
    //                       return (
    //                         <RightMessage key={id} date={message.hora}>
    //                           {message.content}
    //                         </RightMessage>
    //                       );
    //                     } else if (message.type == "left") {
    //                       return (
    //                         <LeftMessage key={id} date={message.hora}>
    //                           {message.content}
    //                         </LeftMessage>
    //                       );
    //                     }
    ...
    //                     <AiOutlinePaperClip
    //                       onClick={() => {
    //                         receiveMessage({ content: "e aí", hora: new Date() });
    //                       }}
    //                     />
    //                   </div>
